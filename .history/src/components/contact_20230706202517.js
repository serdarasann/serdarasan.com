                ...
                <div className="container mx-auto">
                    ...
                    <div className="mt-10 w-full text-center">
                        ...
                        <div className="inline-flex flex-col w-full max-w-lg items-center justify-center">
                            <input className="w-full rounded-3xl p-4 mb-6" type="text" name="" placeholder="Name *" />
                            <input className="w-full rounded-3xl p-4 mb-6" type="text" name="" placeholder="Last Name *" />
                            <input className="w-full rounded-3xl p-4 mb-6" type="email" name="" placeholder="E-Mail Address *" />
                            <textarea className="w-full rounded-3xl p-4 mb-6 resize-none h-40" rows="" cols="" placeholder="Subject *"></textarea>
                        </div>
                    </div>
                </div>
            </section> 
