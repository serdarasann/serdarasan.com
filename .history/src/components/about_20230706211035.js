            ...
            <section id="setAbout" className="relative bg-[#514f50] pt-20 pb-20">
                <div className="container mx-auto pl-5 pr-5">
                    ...
                    <div className="flex text-center gap-40 justify-center mt-20">
                        <div className="text-9xl text-white flex-none font-extrabold md:max-lg:text-6xl">10+<span className="block text-2xl font-light mt-3">YEARS OF<br/>EXPERIENCE</span></div>
                        <div className="text-9xl text-white flex-none font-extrabold md:max-lg:text-6xl">99+<span className="block text-2xl font-light mt-3">COMPLETED<br/>PROJECT</span></div>
                    </div>
                </div>
            </section>
        </>
