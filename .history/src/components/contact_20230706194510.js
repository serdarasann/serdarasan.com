            ...
            <section className="relative bg-[#514f50] pt-20 pb-20">
                <div className="container mx-auto">
                    ...
                    <div className="flex items-center justify-center">
                        <a className="p-3 rounded-full border border-white text-5xl text-white" href="https://github.com/serdarasann"><AiOutlineGithub /></a>
                        <a className="" href="https://twitter.com/deviziwi"><AiOutlineTwitter /></a>
                        <a className="" href="https://wa.me/905466498889"><IoLogoWhatsapp /></a>
                        <a className="" href="https://www.instagram.com/serdarasann/"><AiFillInstagram /></a>
                        <a className="" href="mailto:serdarasann@gmail.com"><AiFillMail /></a>
                    </div>
                </div>
            </section> 
        </> 
