        ...
        <div className='container mx-auto p-4'>
            <div className='flex justify-between items-center'>
                ...
                <div className='text-right'>
                    <div onClick={toggleMenu} className={`${isOpen ? 'text-black -top-5' : ''} text-white p-2 text-3xl hidden max-sm:inline-block relative z-40`}>{isOpen ? <LiaTimesSolid /> : <RxHamburgerMenu />}</div>
