                ...
                <div className="container mx-auto">
                    ...
                    <div className="mt-10 w-full text-center">
                        ...
                        <div className="inline-flex flex-col w-full max-w-lg items-center justify-center">
                            <input className="w-full " type="text" name="" value="" placeholder="Name *" />
                            <input className="w-full " type="text" name="" value="" placeholder="Last Name *" />
                            <input className="w-full " type="email" name="" value="" placeholder="E-Mail Address *" />
