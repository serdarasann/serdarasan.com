            ...
            <section className="relative bg-[#514f50] pt-20 pb-20">
                <div className="container mx-auto">
                    ...
                    <div className="flex items-center justify-center">
                        <a className="" target="_blank" href="https://github.com/serdarasann"><AiOutlineGithub /></a>
                        <a className="" target="_blank" href="https://twitter.com/deviziwi"><AiOutlineTwitter /></a>
                        <a className="" target="_blank" href="https://wa.me/905466498889"><IoLogoWhatsapp /></a>
                        <a className="" target="_blank" href="https://www.instagram.com/serdarasann/"><AiFillInstagram /></a>
                        <a className="" target="_blank" href="mailto:serdarasann@gmail.com"><AiFillMail /></a>
                    </div>
                </div>
            </section>
        </>
