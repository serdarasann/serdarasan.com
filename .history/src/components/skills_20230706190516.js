                    ...
                    <div className="flex justify-center gap-20">
                        <div className="flex-none w-96 flex gap-5 flex-col">
                            <div className="">
                                ...
                                <div className="rounded w-full h-2 bg-slate-200 relative before:absolute before:rounded before:top-0 before:left-0 before:bottom-0 before:w-[90%] before:bg-[#ffcd57]"></div>
                            </div>
                            <div className="">
                                <div className="text-white font-medium flex justify-between mb-2">HTML5/CSS3<span>95%</span></div>
                                <div className="rounded w-full h-2 bg-slate-200 relative before:absolute before:rounded before:top-0 before:left-0 before:bottom-0 before:w-[95%] before:bg-[#ffcd57]"></div>
                            </div>
                            <div className="">
                                <div className="text-white font-medium flex justify-between mb-2">Js/Jquery<span>80%</span></div>
                                <div className="rounded w-full h-2 bg-slate-200 relative before:absolute before:rounded before:top-0 before:left-0 before:bottom-0 before:w-[80%] before:bg-[#ffcd57]"></div>
                            </div>
                        </div>
