        ...
        <div className='container mx-auto p-4'>
            <div className='flex justify-between items-center'>
                ...
                <div className='text-right'>
                    ...
                    <ul className='sm:flex sm:items-center max-sm:text-left gap-10 max-sm:fixed max-sm:top-0 max-sm:right-0 max-sm:bottom-0 max-sm:bg-white max-sm:w-1/3 max-sm:gap-2 max-sm:p-6'>
                        <li 
