            ...
            <section className="relative bg-[#514f50] pt-20 pb-20">
                <div className="container mx-auto">
                    ...
                    <div className="flex items-center justify-center">
                        ...
                        <a target="_blank" href="https://twitter.com/deviziwi" className=""><AiOutlineTwitter /></a>
                        <a target="_blank" href="https://wa.me/905466498889" className=""><IoLogoWhatsapp /></a>
                        <a target="_blank" href="https://www.instagram.com/serdarasann/" className=""><AiFillInstagram /></a>
                        <a target="_blank" href="mailto:serdarasann@gmail.com" className=""><AiFillMail /></a>
                    </div>
                </div>
            </section>
        </>
