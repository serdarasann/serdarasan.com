...
function About() {
    return (
        <>
            <section id="" className="relative bg-[#514f50] pt-20 pb-20">
                <div className="container mx-auto">
                    ...
                    <div className="flex text-center gap-40 justify-center mt-20">
                        <div className="text-9xl text-white flex-none mr-10 font-extrabold">10+<span className="block text-2xl font-light mt-3">YEARS OF<br/>EXPERIENCE</span></div>
                        <div className="text-9xl text-white flex-none mr-10 font-extrabold">99+<span className="block text-2xl font-light mt-3">COMPLETED<br/>PROJECT</span></div>
                    </div>
                </div>
            </section>
        </>
