                ...
                <div className="container mx-auto">
                    ...
                    >
                        <div className="coverText text-center relative z-10">
                            <div className="title text-7xl text-white font-semibold">Hello, My name is <span className="font-light text-[#ffcd57]">Serdar<span className="animate-ping text-8xl relative top-3">I</span></span></div>
