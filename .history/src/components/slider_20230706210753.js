                ...
                <div className="container mx-auto">
                    ...
                    >
                        <div className="coverText text-center relative z-10">
                            <div className="title text-7xl text-white font-semibold md:max-lg:text-6xl">Hello, My name is <span className="font-light text-[#ffcd57]">Serdar<span className="animate-ping text-8xl relative top-2.5 md:max-lg:text-9xl">I</span></span></div>
