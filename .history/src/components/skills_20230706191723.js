            ...
            <div className="container mx-auto">
                <div className="pt-20 pb-20">
                    ...
                    <div className="text-center mt-14">
                        <a className="inline-block rounded-full border border-white text-white pt-3 pb-3 pl-6 pr-6 transition hover:bg-white" href="serdarasan-cv.pdf" download>Download Cv</a>
                    </div>
                </div>
            </div>
        </section>
