            ...
            <section className="relative bg-[#514f50] pt-20 pb-20">
                <div className="container mx-auto">
                    ...
                    <div className="mt-10 w-full text-center">
                        <div className="text-white mb-5 font-medium text-2xl">Contact Form</div>
                        <div className="inline-flex flex-col w-full max-w-lg items-center justify-center">
                            <input className="w-full rounded-full p-4 mb-6" type="text" name="" value="" placeholder="Name *" />
                            <input className="w-full rounded-full p-4 mb-6" type="text" name="" value="" placeholder="Last Name *" />
                            <input className="w-full rounded-full p-4 mb-6" type="email" name="" value="" placeholder="E-Mail Address *" />
                            <textarea rows="" cols="" placeholder="Subject *"></textarea>
                        </div>
                    </div>
                </div>
            </section> 
