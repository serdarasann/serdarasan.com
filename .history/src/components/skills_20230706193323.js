            ...
            <div className="container mx-auto">
                <div className="pt-20 pb-20">
                    ...
                    <div className="text-center mt-20">
                        <a className="inline-block rounded-full border border-white text-white pt-3 pb-3 pl-6 pr-6 transition hover:bg-white hover:text-[#636363]" href="serdarasan-cv.pdf" download>Download CV <AiOutlineCloudDownload/></a>
                    </div>
                </div>
            </div>
        </section>
